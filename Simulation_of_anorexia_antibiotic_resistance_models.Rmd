...
```{r fig4, fig.height=4, fig.width=6, fig.cap="Mean resource and pathogen strain abundances across stochastic simulations for different levels of host resource ingestion."}
...
```
```{r lowIngestFig, fig.height=4, fig.width=6, fig.cap="Probability of drug-resistance emerging when ingestion is low. Regardless of mutation rate, drug resistance does not emerge because the host ingestion is such that there are not enough resources under any circumstance to sustain the drug resistant strain."}
...
```{r variableIngestFig, fig.height=4, fig.width=6, fig.cap="Probability of drug-resistance emerging when ingestion depends on the drug dose."}
